...
var ui = map[string][7]string{
	...
	"workout.per_side":  {"на каждую сторону", "per side", "her taraf", "pro Seite", "por lado", "par côté", "per lato"},
	...
	"settings.reset_confirm": {"Сбросить весь прогресс? Отменить нельзя.", "Reset all progress? This can't be undone.", "Tüm ilerleme sıfırlansın mı? Geri alınamaz.", "Den gesamten Fortschritt zurücksetzen? Nicht rückgängig machbar.", "¿Reiniciar todo el progreso? No se puede deshacer.", "Réinitialiser toute la progression ? Action irréversible.", "Azzerare tutti i progressi? L'azione è irreversibile."},
	"settings.reset_yes":     {"Да, сбросить", "Yes, reset", "Evet, sıfırla", "Ja, zurücksetzen", "Sí, reiniciar", "Oui, réinitialiser", "Sì, azzera"},
	"settings.cancel":        {"Отмена", "Cancel", "İptal", "Abbrechen", "Cancelar", "Annuler", "Annulla"},
	...
	"enc.6":  {"Сделано на отлично!", "Nailed it!", "Tam isabet!", "Top gemacht!", "¡Clavado!", "Parfait !", "Perfetto!"},
	"enc.7":  {"Утро покорено!", "Morning conquered!", "Sabah fethedildi!", "Der Morgen ist erobert!", "¡Mañana conquistada!", "Matin conquis !", "Mattina conquistata!"},
	"enc.8":  {"На шаг ближе к цели!", "One step closer!", "Hedefe bir adım daha!", "Einen Schritt näher!", "¡Un paso más cerca!", "Un pas de plus !", "Un passo più vicino!"},
	"enc.9":  {"Будущий ты скажет спасибо!", "Future you says thanks!", "Gelecekteki sen teşekkür eder!", "Dein Zukunfts-Ich dankt dir!", "¡Tu yo futuro te lo agradece!", "Ton toi futur te remercie !", "Il tuo io futuro ti ringrazia!"},
	"enc.10": {"Регулярность побеждает всё!", "Consistency wins!", "Süreklilik kazanır!", "Beständigkeit gewinnt!", "¡La constancia gana!", "La régularité gagne !", "La costanza vince!"},
	"enc.11": {"Ты пришёл — это главное!", "You showed up — that's everything!", "Geldin — en önemlisi bu!", "Du warst da — das zählt!", "Apareciste, eso es todo.", "Tu es venu, c'est l'essentiel !", "Ci sei stato, è tutto!"},
	"enc.12": {"Энергия на весь день!", "Energy for the whole day!", "Tüm güne enerji!", "Energie für den ganzen Tag!", "¡Energía para todo el día!", "De l'énergie pour la journée !", "Energia per tutta la giornata!"},
	"enc.13": {"Сильнее, чем вчера!", "Stronger than yesterday!", "Dünden daha güçlü!", "Stärker als gestern!", "¡Más fuerte que ayer!", "Plus fort qu'hier !", "Più forte di ieri!"},
	"enc.14": {"Сегодня без отговорок!", "No excuses today!", "Bugün bahane yok!", "Heute keine Ausreden!", "¡Hoy sin excusas!", "Aujourd'hui, zéro excuse !", "Oggi niente scuse!"},
	"enc.15": {"Маленькая победа — большой разгон!", "Small win, big momentum!", "Küçük zafer, büyük ivme!", "Kleiner Sieg, großer Schwung!", "Pequeña victoria, gran impulso.", "Petite victoire, grand élan !", "Piccola vittoria, grande slancio!"},
	"enc.16": {"Сделано ещё до начала дня!", "Done before the day began!", "Gün başlamadan tamamlandı!", "Erledigt, bevor der Tag begann!", "¡Hecho antes de empezar el día!", "Fait avant même le début du jour !", "Fatto prima ancora che il giorno inizi!"},
	"enc.17": {"Копи дни — копи силу!", "Stack the days!", "Günleri biriktir!", "Sammle die Tage!", "¡Suma los días!", "Empile les jours !", "Accumula i giorni!"},
	"enc.18": {"Вот это характер!", "That's character!", "İşte karakter!", "Das ist Charakter!", "¡Eso es carácter!", "Ça, c'est du caractère !", "Questo è carattere!"},
	"enc.19": {"Гордись собой!", "Be proud of yourself!", "Kendinle gurur duy!", "Sei stolz auf dich!", "¡Siéntete orgulloso!", "Sois fier de toi !", "Sii orgoglioso di te!"},
}
