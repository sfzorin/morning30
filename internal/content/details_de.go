...
var detailsDE = map[string]Detail{
	...
	"W09": {
		...
		Correct: []string{"Arme bewegen sich frei.", "Schultern bleiben entspannt.", "Brust öffnet sanft.", "Körper bleibt aufrecht."},
		Wrong:   []string{"Zu kräftig schwingen.", "Die Schultern zu den Ohren heben.", "Den unteren Rücken überstrecken.", "Die Bewegung in unkontrollierten Schwung übergehen lassen."},
	},
	"C13": {
		...
		Correct: []string{"Die Drehung kommt aus dem Rumpf.", "Unterer Rücken bleibt kontrolliert.", "Nacken bleibt entspannt.", "Bewegung ist weich."},
		Wrong:   []string{"Am Nacken ziehen.", "Nur die Ellbogen bewegen.", "Die Wiederholungen hetzen.", "Den unteren Rücken überstrecken lassen."},
	},
	"B11": {
	...
	"L10": {
		...
		Correct: []string{"Knie folgen den Zehen.", "Fersen bleiben am Boden.", "Rücken bleibt lang.", "Tiefe bleibt kontrolliert."},
		Wrong:   []string{"Die Knie nach innen fallen lassen.", "Die Fersen heben.", "Den Rücken runden.", "Zu schnell nach unten fallen."},
	},
	"L11": {
		...
		Correct: []string{"Vorderes Knie folgt den Zehen.", "Oberkörper bleibt aufrecht.", "Schritt zurück ist kontrolliert.", "Vordere Ferse bleibt am Boden."},
		Wrong:   []string{"Das vordere Knie nach innen fallen lassen.", "Zu weit nach vorn lehnen.", "Zu schnell absenken.", "Sich zu stark vom hinteren Bein abstoßen."},
	},
	"L12": {
	...
	"J01": {
		...
		Correct: []string{"Sprünge bleiben niedrig.", "Landungen sind weich und leise.", "Knie bleiben leicht gebeugt.", "Körper bleibt aufrecht."},
		Wrong:   []string{"Zu hoch springen.", "Laut landen.", "Die Knie durchstrecken.", "Die Sprunggelenke nach innen oder außen kippen lassen."},
	},
	"J02": {
		...
		Correct: []string{"Oberkörper bleibt aufrecht.", "Knie heben kontrolliert.", "Füße landen weich.", "Atmung bleibt gleichmäßig."},
		Wrong:   []string{"Nach hinten lehnen.", "Die Beine ohne Kontrolle schwingen.", "Mit den Füßen aufstampfen.", "Die Luft anhalten."},
	},
	"J03": {
		...
		Correct: []string{"Weich landen.", "Die Knie leicht gebeugt halten.", "Arme bewegen sich weich.", "Atmung bleibt rhythmisch."},
		Wrong:   []string{"Hart landen.", "Die Knie durchstrecken.", "Die Schultern hochziehen.", "Zu schnell bewegen und die Kontrolle verlieren."},
	},
	"J04": {
		...
		Correct: []string{"Körper bleibt in einer festen Plank.", "Rumpf bleibt fest.", "Schultern bleiben über den Händen.", "Knie bewegen sich kontrolliert."},
		Wrong:   []string{"Das Becken nach oben springen lassen.", "Den unteren Rücken durchhängen lassen.", "Die Füße zu wild bewegen.", "Die Schultern einsinken lassen."},
	},
	"J05": {
		...
		Correct: []string{"Leise landen.", "Knie folgen den Zehen.", "Brust bleibt offen.", "Jeder Sprung ist kontrolliert."},
		Wrong:   []string{"Hart landen.", "Die Knie nach innen fallen lassen.", "Springen, bevor die Kniebeuge stabil ist.", "Ohne neues Einnehmen der Position hetzen."},
	},
	"J06": {
		...
		Correct: []string{"Landungen sind leise.", "Knie folgt den Zehen.", "Oberkörper bleibt kontrolliert.", "Die Bewegung von Seite zu Seite ist weich."},
		Wrong:   []string{"Mit nach innen fallendem Knie landen.", "Zu früh zu weit springen.", "In die Landung fallen.", "Das Knie beim Aufsetzen verdrehen."},
	},
	"J07": {
		...
		Correct: []string{"Knie heben bis auf Hüfthöhe.", "Landungen bleiben leicht.", "Rumpf bleibt aktiv.", "Oberkörper bleibt aufrecht."},
		Wrong:   []string{"Nach hinten lehnen.", "Hart landen.", "Die Füße auf den Boden klatschen lassen.", "Mit steigendem Tempo die Haltung verlieren."},
	},
	"J08": {
		...
		Correct: []string{"Hände landen unter den Schultern.", "Plank-Position ist fest.", "Füße landen weich.", "Sprung ist kontrolliert."},
		Wrong:   []string{"Den unteren Rücken in der Plank durchhängen lassen.", "Hart landen.", "Mit schlampigen Wiederholungen hetzen.", "Beim Vorspringen die Knie nach innen fallen lassen."},
	},
	"J09": {
		...
		Correct: []string{"Landung ist weich und kontrolliert.", "Vorderes Knie folgt den Zehen.", "Oberkörper bleibt aufrecht.", "Der Bewegungsumfang bleibt sicher."},
		Wrong:   []string{"Hart landen.", "Das vordere Knie nach innen fallen lassen.", "Zu tief absenken.", "Schneller bewegen, als du kontrollieren kannst."},
	},
	"CD07": {
