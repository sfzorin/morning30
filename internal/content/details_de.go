...
var detailsDE = map[string]Detail{
	...
	// ---- Ilya: leichte Hanteln 0,5 kg ----
	"D01": {
		Desc:      "Eine langsame Außenrotation der Schulter für Stabilität bei Aufschlag und Grundschlägen. Eine 0,5-kg-Hantel, ein Arm nach dem anderen.",
		HowTo:     []string{"Aufrecht stehen, eine 0,5-kg-Hantel in einer Hand.", "Den Ellbogen auf 90° beugen und an die Seite pressen.", "Der Unterarm startet vor dem Bauch.", "Den Unterarm langsam nach außen drehen, weg vom Körper.", "Langsam zurück und den Arm wechseln."},
		Correct:   []string{"Der Ellbogen bleibt an der Seite.", "Langsam bewegen, nicht schwingen.", "Die Schulter bleibt unten.", "Das Handgelenk bleibt gerade."},
		Wrong:     []string{"Lass den Ellbogen nicht nach vorn oder außen wandern.", "Reiß die Hantel nicht.", "Zuck nicht mit der Schulter.", "Nimm keine schwerere Hantel."},
		Breathing: "Gleichmäßig atmen, nicht die Luft anhalten.",
		Safety:    "Nur 0,5 kg. Bei Schulterschmerz aufhören. Nicht mit der Hantel laufen oder springen.",
		Voice:     Voice{Start: "Halbes Kilo. Ellbogen an die Seite.", Mid: []string{"Unterarm langsam nach außen.", "Ellbogen bleibt."}, Finish: "Hantel ablegen."},
	},
	"D02": {
		Desc:      "Reverse Fly im Vornüberbeugen für hintere Schulter und Schulterblätter — Haltung fürs Tennis.",
		HowTo:     []string{"In jede Hand eine 0,5-kg-Hantel.", "Aus der Hüfte beugen, Rücken gerade, Knie weich.", "Die Arme hängen unter den Schultern.", "Die Arme seitlich bis auf Schulterhöhe heben und die Schulterblätter zusammenziehen.", "Langsam senken."},
		Correct:   []string{"Den Rücken lang und flach halten.", "Bei Schulterhöhe stoppen.", "Die Schulterblätter zusammenziehen.", "Beide Arme zusammen bewegen."},
		Wrong:     []string{"Mach den Rücken nicht rund.", "Schwing die Gewichte nicht.", "Heb nicht über Schulterhöhe.", "Heb den Kopf nicht."},
		Breathing: "Ausatmen, wenn die Arme steigen.",
		Safety:    "Nur 0,5 kg. Knie weich. Nicht mit Hanteln springen.",
		Voice:     Voice{Start: "Beugen, Rücken gerade, halbes Kilo je Hand.", Mid: []string{"Arme zur Seite.", "Schulterblätter zusammen."}, Finish: "Aufrichten und ablegen."},
	},
	"D03": {
		Desc:      "Goblet-Kniebeuge: beide 0,5-kg-Hanteln an der Brust für Beine und eine stabile Schlaghaltung.",
		HowTo:     []string{"Beide 0,5-kg-Hanteln zusammen an der Brust halten.", "Füße etwa schulterbreit.", "Becken nach hinten, Knie beugen.", "Fersen am Boden, Brust offen.", "Aufrichten, ohne dass die Hanteln nach vorn ziehen."},
		Correct:   []string{"Hanteln bleiben an der Brust.", "Fersen am Boden.", "Knie über den Zehen.", "Rücken lang."},
		Wrong:     []string{"Knie nicht nach innen fallen lassen.", "Fersen nicht heben.", "Hanteln nicht nach vorn ziehen lassen.", "Nicht aus der Tiefe springen."},
		Breathing: "Einatmen nach unten, ausatmen nach oben.",
		Safety:    "Nicht mit Hanteln springen. Bei Knieschmerz Körpergewicht-Kniebeuge.",
		Voice:     Voice{Start: "Hanteln an der Brust. Langsame Kniebeuge.", Mid: []string{"Fersen unten.", "Knie über den Zehen."}, Finish: "Aufrichten."},
	},
	"D04": {
		Desc:      "Stillhalten mit 0,5-kg-Hanteln über dem Kopf — Schulterstabilität wie beim Aufschlag.",
		HowTo:     []string{"In jede Hand eine 0,5-kg-Hantel.", "Beide Arme gerade über den Kopf drücken.", "Bizeps nah an den Ohren.", "Rippen unten, Bauch fest.", "Stillhalten und atmen, dann langsam senken."},
		Correct:   []string{"Arme an den Ohren.", "Rippen unten, kein Hohlkreuz.", "Schultern weg von den Ohren.", "Weiter atmen."},
		Wrong:     []string{"Nicht nach hinten lehnen.", "Nicht zucken.", "Ellbogen nicht überstrecken.", "Gewichte nicht reißen."},
		Breathing: "Ruhig atmen. Nie die Luft anhalten.",
		Safety:    "Nur halten, nicht drücken oder schwingen. Bei Zittern oder Schmerz senken.",
		Voice:     Voice{Start: "Halbes Kilo über dem Kopf. Arme an den Ohren.", Mid: []string{"Rippen unten.", "Weiter atmen."}, Finish: "Langsam senken."},
	},
	"D05": {
		Desc:      "Kofferhalten: eine 0,5-kg-Hantel in einer Hand. Aufgabe: aufrecht bleiben und nicht zur Seite kippen.",
		HowTo:     []string{"Eine 0,5-kg-Hantel in einer Hand, Arm am Oberschenkel.", "Füße unter der Hüfte.", "Aufrecht bleiben: nicht zum Gewicht und nicht weglehnen.", "Stillhalten und atmen.", "Dann die Hand wechseln."},
		Correct:   []string{"Scheitel nach oben.", "Schultern auf einer Höhe.", "Rippen ruhig.", "Knie weich, nicht durchgedrückt."},
		Wrong:     []string{"Nicht zur Seite lehnen.", "Die belastete Schulter nicht hochziehen.", "Nicht gehen oder hüpfen.", "Nicht die Luft anhalten."},
		Breathing: "Ruhig ein- und ausatmen.",
		Safety:    "Auf der Stelle stehen. Nicht gehen, laufen oder springen mit der Hantel.",
		Voice:     Voice{Start: "Ein halbes Kilo in einer Hand. Aufrecht stehen.", Mid: []string{"Nicht lehnen.", "Schultern eben."}, Finish: "Hand wechseln."},
	},
}
