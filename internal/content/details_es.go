...
var detailsES = map[string]Detail{
	...
	// ---- Ilya: mancuernas ligeras de 0,5 kg ----
	"D01": {
		Desc:      "Rotación externa lenta del hombro para estabilizar el saque y los golpes. Una mancuerna de 0,5 kg, un brazo cada vez.",
		HowTo:     []string{"Ponte de pie con una mancuerna de 0,5 kg.", "Dobla el codo a 90° y pégalo al costado.", "El antebrazo empieza cruzado sobre el abdomen.", "Gira el antebrazo hacia fuera, despacio.", "Vuelve despacio y cambia de brazo."},
		Correct:   []string{"El codo permanece pegado al costado.", "Muévete despacio, sin balanceo.", "El hombro lejos de la oreja.", "La muñeca recta."},
		Wrong:     []string{"No dejes que el codo se adelante o se abra.", "No tirones.", "No encojas el hombro.", "No uses una mancuerna más pesada."},
		Breathing: "Respira con regularidad; no aguantes la respiración.",
		Safety:    "Solo 0,5 kg. Para si duele el hombro. No corras ni saltes con la mancuerna.",
		Voice:     Voice{Start: "Mancuerna de medio kilo. Codo pegado al costado.", Mid: []string{"Antebrazo hacia fuera, despacio.", "El codo no se mueve."}, Finish: "Deja la mancuerna."},
	},
	"D02": {
		Desc:      "Aperturas invertidas inclinadas para la parte posterior del hombro y las escápulas.",
		HowTo:     []string{"Una mancuerna de 0,5 kg en cada mano.", "Inclínate desde las caderas, espalda recta, rodillas blandas.", "Los brazos cuelgan bajo los hombros.", "Sube los brazos a los lados hasta la altura de los hombros y junta las escápulas.", "Baja despacio."},
		Correct:   []string{"Espalda larga y plana.", "Para a la altura de los hombros.", "Junta las escápulas.", "Los dos brazos a la vez."},
		Wrong:     []string{"No redondees la espalda.", "No balancees el peso.", "No subas por encima de los hombros.", "No levantes la cabeza."},
		Breathing: "Exhala al subir los brazos.",
		Safety:    "Solo 0,5 kg. Rodillas blandas. No saltes con las mancuernas.",
		Voice:     Voice{Start: "Inclínate, espalda recta, medio kilo en cada mano.", Mid: []string{"Brazos a los lados.", "Junta las escápulas."}, Finish: "Levántate y déjalas."},
	},
	"D03": {
		Desc:      "Sentadilla goblet: las dos mancuernas de 0,5 kg en el pecho para piernas y una postura estable de golpe.",
		HowTo:     []string{"Sujeta ambas mancuernas de 0,5 kg juntas en el pecho.", "Pies más o menos a la anchura de los hombros.", "Caderas atrás y dobla las rodillas.", "Talones en el suelo, pecho alto.", "Levántate sin dejar que el peso se vaya hacia delante."},
		Correct:   []string{"Las mancuernas siguen en el pecho.", "Talones en el suelo.", "Rodillas en la línea de los pies.", "Espalda larga."},
		Wrong:     []string{"No dejes que las rodillas se hundan hacia dentro.", "No levantes los talones.", "No dejes que las mancuernas te tiren hacia delante.", "No rebotes abajo."},
		Breathing: "Inhala al bajar, exhala al subir.",
		Safety:    "No saltes con las mancuernas. Si duele la rodilla, sentadilla sin peso.",
		Voice:     Voice{Start: "Mancuernas en el pecho. Sentadilla lenta.", Mid: []string{"Talones abajo.", "Rodillas en línea."}, Finish: "Ponte derecho."},
	},
	"D04": {
		Desc:      "Sostén quieto con mancuernas de 0,5 kg por encima de la cabeza: estabilidad de hombro como en el saque.",
		HowTo:     []string{"Una mancuerna de 0,5 kg en cada mano.", "Empuja ambos brazos rectos por encima de la cabeza.", "Bíceps cerca de las orejas.", "Costillas abajo, abdomen activo.", "Quédate quieto y respira; luego baja despacio."},
		Correct:   []string{"Brazos junto a las orejas.", "Costillas abajo, sin arquear la lumbar.", "Hombros lejos de las orejas.", "Sigue respirando."},
		Wrong:     []string{"No te eches atrás.", "No encojas los hombros.", "No bloquees los codos a la fuerza.", "No empujes con un tirón."},
		Breathing: "Respiración lenta. Nunca aguantes el aire.",
		Safety:    "Solo sostener, sin presses ni balanceos. Si el hombro tiembla o duele, baja.",
		Voice:     Voice{Start: "Medio kilo arriba. Brazos junto a las orejas.", Mid: []string{"Costillas abajo.", "Sigue respirando."}, Finish: "Baja despacio."},
	},
	"D05": {
		Desc:      "Sostén de maleta: una mancuerna de 0,5 kg en una mano. El trabajo es no inclinarse de lado.",
		HowTo:     []string{"Una mancuerna de 0,5 kg en una mano, el brazo junto al muslo.", "Pies bajo las caderas.", "Mantente alto: no te inclines hacia el peso ni hacia el otro lado.", "Quédate quieto y respira.", "Cambia de mano."},
		Correct:   []string{"Coronilla hacia arriba.", "Hombros a la misma altura.", "Costillas quietas.", "Rodillas blandas, no bloqueadas."},
		Wrong:     []string{"No te inclines de lado.", "No subas el hombro de la mancuerna.", "No camines ni rebotes.", "No aguantes la respiración."},
		Breathing: "Respiración calmada.",
		Safety:    "Quédate en el sitio. No camines, corras ni saltes con la mancuerna.",
		Voice:     Voice{Start: "Una mancuerna de medio kilo en una mano. Ponte alto.", Mid: []string{"No te inclines.", "Hombros nivelados."}, Finish: "Cambia de mano."},
	},
}
