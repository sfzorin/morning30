...
var detailsES = map[string]Detail{
	...
	"W09": {
		...
		Correct: []string{"Los brazos se mueven con libertad.", "Los hombros se mantienen relajados.", "El pecho se abre con suavidad.", "El cuerpo se mantiene erguido."},
		Wrong:   []string{"Balancearse con demasiada fuerza.", "Subir los hombros a las orejas.", "Arquear la zona lumbar.", "Convertir el movimiento en un impulso descontrolado."},
	},
	"C13": {
		...
		Correct: []string{"La rotación sale del tronco.", "La zona lumbar se mantiene controlada.", "El cuello relajado.", "El movimiento es suave."},
		Wrong:   []string{"Tirar del cuello.", "Mover solo los codos.", "Apresurar las repeticiones.", "Dejar que la zona lumbar se arquee."},
	},
	"B11": {
	...
	"L10": {
		...
		Correct: []string{"Las rodillas siguen la línea de los pies.", "Los talones se mantienen en el suelo.", "La espalda se mantiene larga.", "La profundidad se mantiene controlada."},
		Wrong:   []string{"Dejar caer las rodillas hacia dentro.", "Levantar los talones.", "Redondear la espalda.", "Bajar demasiado rápido."},
	},
	"L11": {
		...
		Correct: []string{"La rodilla delantera sigue la línea de los pies.", "El torso se mantiene erguido.", "El paso atrás es controlado.", "El talón delantero se mantiene en el suelo."},
		Wrong:   []string{"Dejar caer la rodilla delantera hacia dentro.", "Inclinarse demasiado hacia delante.", "Bajar rápido.", "Empujar con la pierna trasera con demasiada fuerza."},
	},
	"L12": {
	...
	"J01": {
		...
		Correct: []string{"Los saltos se mantienen bajos.", "Los aterrizajes son suaves y silenciosos.", "Las rodillas se mantienen algo flexionadas.", "El cuerpo se mantiene erguido."},
		Wrong:   []string{"Saltar demasiado alto.", "Aterrizar con ruido.", "Bloquear las rodillas.", "Volcar los tobillos hacia dentro o hacia fuera."},
	},
	"J02": {
		...
		Correct: []string{"El torso se mantiene erguido.", "Las rodillas suben con control.", "Los pies aterrizan con suavidad.", "La respiración se mantiene constante."},
		Wrong:   []string{"Inclinarse hacia atrás.", "Balancear las piernas sin control.", "Pisar con fuerza.", "Aguantar la respiración."},
	},
	"J03": {
		...
		Correct: []string{"Aterriza con suavidad.", "Mantén las rodillas algo flexionadas.", "Los brazos se mueven con suavidad.", "La respiración se mantiene rítmica."},
		Wrong:   []string{"Aterrizar fuerte.", "Bloquear las rodillas.", "Encoger los hombros.", "Moverse demasiado rápido y perder el control."},
	},
	"J04": {
		...
		Correct: []string{"El cuerpo se mantiene en una plancha firme.", "El core se mantiene apretado.", "Los hombros se mantienen sobre las manos.", "Las rodillas se mueven con control."},
		Wrong:   []string{"Dejar que la cadera rebote hacia arriba.", "Dejar caer la zona lumbar.", "Mover los pies de forma descontrolada.", "Dejar que los hombros se hundan."},
	},
	"J05": {
		...
		Correct: []string{"Aterriza en silencio.", "Las rodillas siguen la línea de los pies.", "El pecho se mantiene abierto.", "Cada salto es controlado."},
		Wrong:   []string{"Aterrizar fuerte.", "Dejar caer las rodillas hacia dentro.", "Saltar antes de que la sentadilla sea estable.", "Apresurarse sin recolocarse."},
	},
	"J06": {
		...
		Correct: []string{"Los aterrizajes son silenciosos.", "La rodilla sigue la línea de los pies.", "El torso se mantiene controlado.", "El movimiento de lado a lado es suave."},
		Wrong:   []string{"Aterrizar dejando caer la rodilla hacia dentro.", "Saltar demasiado lejos demasiado pronto.", "Caer en el aterrizaje.", "Torcer la rodilla al contacto."},
	},
	"J07": {
		...
		Correct: []string{"Las rodillas suben hacia la altura de la cadera.", "Los aterrizajes se mantienen ligeros.", "El core se mantiene activo.", "El torso se mantiene erguido."},
		Wrong:   []string{"Inclinarse hacia atrás.", "Aterrizar con fuerza.", "Dejar que los pies golpeen el suelo.", "Perder la postura al aumentar el ritmo."},
	},
	"J08": {
		...
		Correct: []string{"Las manos aterrizan bajo los hombros.", "La posición de plancha es firme.", "Los pies aterrizan con suavidad.", "El salto es controlado."},
		Wrong:   []string{"Dejar caer la zona lumbar en la plancha.", "Aterrizar con fuerza.", "Apresurar las repeticiones con técnica descuidada.", "Dejar caer las rodillas hacia dentro al saltar hacia delante."},
	},
	"J09": {
		...
		Correct: []string{"El aterrizaje es suave y controlado.", "La rodilla delantera sigue la línea de los pies.", "El torso se mantiene erguido.", "El rango de movimiento se mantiene seguro."},
		Wrong:   []string{"Aterrizar fuerte.", "Dejar caer la rodilla delantera hacia dentro.", "Bajar demasiado.", "Moverse más rápido de lo que puedes controlar."},
	},
	"CD07": {
