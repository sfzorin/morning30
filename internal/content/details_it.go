...
var detailsIT = map[string]Detail{
	...
	// ---- Ilya: manubri leggeri da 0,5 kg ----
	"D01": {
		Desc:      "Rotazione esterna lenta della spalla per stabilizzare servizio e colpi. Un manubrio da 0,5 kg, un braccio alla volta.",
		HowTo:     []string{"Stai dritto con un manubrio da 0,5 kg.", "Piega il gomito a 90° e tienilo incollato al fianco.", "L'avambraccio parte davanti alla pancia.", "Ruota lentamente l'avambraccio verso l'esterno.", "Torna piano e cambia braccio."},
		Correct:   []string{"Il gomito resta incollato al fianco.", "Movimento lento, senza slancio.", "Spalla lontana dall'orecchio.", "Polso dritto."},
		Wrong:     []string{"Non lasciare che il gomito vada avanti o fuori.", "Non strappare il peso.", "Non alzare la spalla.", "Non usare un manubrio più pesante."},
		Breathing: "Respira in modo regolare, non trattenerlo.",
		Safety:    "Solo 0,5 kg. Fermati se la spalla fa male. Non correre né saltare con il manubrio.",
		Voice:     Voice{Start: "Manubrio da mezzo chilo. Gomito al fianco.", Mid: []string{"Avambraccio verso l'esterno, piano.", "Il gomito resta."}, Finish: "Appoggia il manubrio."},
	},
	"D02": {
		Desc:      "Reverse fly piegato per la parte posteriore della spalla e le scapole — la postura del tennista.",
		HowTo:     []string{"Un manubrio da 0,5 kg in ogni mano.", "Piega dalle anche, schiena dritta, ginocchia morbide.", "Le braccia pendono sotto le spalle.", "Alza le braccia ai lati fino all'altezza delle spalle e stringi le scapole.", "Scendi lentamente."},
		Correct:   []string{"Schiena lunga e piatta.", "Fermati all'altezza delle spalle.", "Stringi le scapole.", "Entrambe le braccia insieme."},
		Wrong:     []string{"Non arrotondare la schiena.", "Non dondolare i pesi.", "Non salire sopra le spalle.", "Non alzare la testa."},
		Breathing: "Espira quando le braccia salgono.",
		Safety:    "Solo 0,5 kg. Ginocchia morbide. Non saltare con i manubri.",
		Voice:     Voice{Start: "Piegato, schiena dritta, mezzo chilo per mano.", Mid: []string{"Braccia ai lati.", "Stringi le scapole."}, Finish: "Rialzati e appoggiali."},
	},
	"D03": {
		Desc:      "Goblet squat: entrambi i manubri da 0,5 kg al petto per le gambe e una postura di colpo stabile.",
		HowTo:     []string{"Tieni entrambi i manubri da 0,5 kg insieme al petto.", "Piedi circa alla larghezza delle spalle.", "Anche indietro e piega le ginocchia.", "Talloni a terra, petto aperto.", "Risali senza far andare i pesi in avanti."},
		Correct:   []string{"I manubri restano al petto.", "Talloni a terra.", "Ginocchia in linea con le punte.", "Schiena lunga."},
		Wrong:     []string{"Non far cadere le ginocchia verso l'interno.", "Non staccare i talloni.", "Non farti trascinare in avanti.", "Non rimbalzare dal basso."},
		Breathing: "Inspira in discesa, espira in salita.",
		Safety:    "Non saltare con i manubri. Se il ginocchio fa male, squat a corpo libero.",
		Voice:     Voice{Start: "Manubri al petto. Squat lento.", Mid: []string{"Talloni a terra.", "Ginocchia in linea."}, Finish: "Stai dritto."},
	},
	"D04": {
		Desc:      "Tenuta ferma con manubri da 0,5 kg sopra la testa — stabilità di spalla come nel servizio.",
		HowTo:     []string{"Un manubrio da 0,5 kg in ogni mano.", "Spingi entrambe le braccia tese sopra la testa.", "Bicipiti vicino alle orecchie.", "Costole in giù, addome attivo.", "Resta fermo e respira, poi scendi lentamente."},
		Correct:   []string{"Braccia vicino alle orecchie.", "Costole in giù, niente inarcamento lombare.", "Spalle lontane dalle orecchie.", "Continua a respirare."},
		Wrong:     []string{"Non inarcarti indietro.", "Non alzare le spalle.", "Non bloccare i gomiti con forza.", "Non strappare i pesi verso l'alto."},
		Breathing: "Respiro calmo. Non trattenerlo mai.",
		Safety:    "Solo tenuta, niente spinte né slanci. Se la spalla trema o fa male, scendi.",
		Voice:     Voice{Start: "Mezzo chilo sopra la testa. Braccia alle orecchie.", Mid: []string{"Costole in giù.", "Continua a respirare."}, Finish: "Scendi lentamente."},
	},
	"D05": {
		Desc:      "Tenuta valigia: un manubrio da 0,5 kg in una mano. Il compito è restare dritti e non piegarsi di lato.",
		HowTo:     []string{"Un manubrio da 0,5 kg in una mano, braccio lungo la coscia.", "Piedi sotto i fianchi.", "Resta alto: non piegarti verso il peso né dall'altra parte.", "Resta fermo e respira.", "Poi cambia mano."},
		Correct:   []string{"Cima della testa verso l'alto.", "Spalle alla stessa altezza.", "Costole calme.", "Ginocchia morbide, non bloccate."},
		Wrong:     []string{"Non piegarti di lato.", "Non alzare la spalla del manubrio.", "Non camminare né rimbalzare.", "Non trattenere il respiro."},
		Breathing: "Respiro calmo.",
		Safety:    "Resta sul posto. Non camminare, correre o saltare con il manubrio.",
		Voice:     Voice{Start: "Un manubrio da mezzo chilo in una mano. Stai dritto.", Mid: []string{"Non piegarti.", "Spalle in linea."}, Finish: "Cambia mano."},
	},
}
