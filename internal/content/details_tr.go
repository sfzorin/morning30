...
var detailsTR = map[string]Detail{
	...
	// ---- Ilya: 0,5 kg hafif dambıllar ----
	"D01": {
		Desc:      "Servis ve vuruşlar için omuz stabilitesine yönelik yavaş dış rotasyon. 0,5 kg dambıl, birer kol.",
		HowTo:     []string{"Dik dur, bir elde 0,5 kg dambıl.", "Dirseği 90° bük ve yanına yapıştır.", "Önkol karın hizasından başlar.", "Önkolu yavaşça dışa, vücuttan uzağa çevir.", "Yavaşça geri getir, sonra kol değiştir."},
		Correct:   []string{"Dirsek yana yapışık kalsın.", "Yavaş hareket et, savurma.", "Omuz kulaktan uzak.", "Bilek düz."},
		Wrong:     []string{"Dirsek öne veya dışa kaçmasın.", "Dambılı savurma.", "Omuzu kaldırma.", "Daha ağır dambıl alma."},
		Breathing: "Düzenli nefes al, nefesi tutma.",
		Safety:    "Sadece 0,5 kg. Omuz ağırırsa dur. Dambılla koşma veya zıplama.",
		Voice:     Voice{Start: "Yarım kiloluk dambıl. Dirsek yana yapışık.", Mid: []string{"Önkol yavaşça dışa.", "Dirsek yerinde."}, Finish: "Dambılı bırak."},
	},
	"D02": {
		Desc:      "Eğilerek reverse fly: arka omuz ve kürek kemikleri — tenis duruşu.",
		HowTo:     []string{"Her elde 0,5 kg dambıl.", "Kalçadan eğil, sırt düz, dizler yumuşak.", "Kollar omuzların altında sarksın.", "Kolları yanlara omuz hizasına kadar kaldır ve kürek kemiklerini sık.", "Yavaşça indir."},
		Correct:   []string{"Sırt uzun ve düz.", "Omuz hizasında dur.", "Kürek kemiklerini sık.", "İki kol birlikte."},
		Wrong:     []string{"Sırtı kamburlaştırma.", "Ağırlıkları savurma.", "Omuzların üzerine çıkarma.", "Başını kaldırma."},
		Breathing: "Kollar kalkarken nefes ver.",
		Safety:    "Sadece 0,5 kg. Dizler yumuşak. Dambıllarla zıplama.",
		Voice:     Voice{Start: "Eğil, sırt düz, her elde yarım kilo.", Mid: []string{"Kollar yana.", "Kürek kemiklerini sık."}, Finish: "Doğrul ve bırak."},
	},
	"D03": {
		Desc:      "Goblet squat: iki 0,5 kg dambıl göğüste — bacaklar ve sağlam vuruş duruşu.",
		HowTo:     []string{"İki 0,5 kg dambılı göğüste birleştir.", "Ayaklar yaklaşık omuz genişliğinde.", "Kalçayı geri at, dizleri bük.", "Topuklar yerde, göğüs açık.", "Ağırlıklar öne kaçmadan kalk."},
		Correct:   []string{"Dambıllar göğüste kalsın.", "Topuklar yerde.", "Dizler ayak ucuyla aynı yönde.", "Sırt uzun."},
		Wrong:     []string{"Dizleri içe düşürme.", "Topukları kaldırma.", "Dambılların seni öne çekmesine izin verme.", "Alttan zıplama."},
		Breathing: "İnerken nefes al, kalkarken ver.",
		Safety:    "Dambıllarla zıplama. Diz ağırırsa ağırlıksız squat.",
		Voice:     Voice{Start: "Dambıllar göğüste. Yavaş squat.", Mid: []string{"Topuklar yerde.", "Dizler ayak ucunda."}, Finish: "Dik dur."},
	},
	"D04": {
		Desc:      "0,5 kg dambılları baş üzerinde hareketsiz tutma — servisteki omuz stabilitesi.",
		HowTo:     []string{"Her elde 0,5 kg dambıl.", "Kolları düz şekilde başın üzerine it.", "Pazılar kulaklara yakın.", "Kaburgalar aşağı, karın sıkı.", "Hareketsiz tut ve nefes al, sonra yavaş indir."},
		Correct:   []string{"Kollar kulak hizasında.", "Kaburgalar aşağı, bel çukurlaşma.", "Omuzlar kulaktan uzak.", "Nefes devam etsin."},
		Wrong:     []string{"Geriye yaslanma.", "Omuzları kaldırma.", "Dirsekleri kilitleyip zorlama.", "Ağırlıkları savurma."},
		Breathing: "Sakin nefes. Nefesi asla tutma.",
		Safety:    "Sadece tut, press veya savurma yok. Omuz titrer veya ağrırsa indir.",
		Voice:     Voice{Start: "Yarım kilo başın üzerinde. Kollar kulaklarda.", Mid: []string{"Kaburgalar aşağı.", "Nefes almaya devam."}, Finish: "Yavaşça indir."},
	},
	"D05": {
		Desc:      "Valiz tutuşu: bir elde 0,5 kg. İş yanlara yatmamak — topa uzanırkenki gövde kontrolü.",
		HowTo:     []string{"Bir elde 0,5 kg dambıl, kol uyluk yanında.", "Ayaklar kalçanın altında.", "Dik dur: ne ağırlığa ne karşı tarafa yat.", "Hareketsiz tut ve nefes al.", "Sonra el değiştir."},
		Correct:   []string{"Tepe yukarı.", "Omuzlar aynı seviyede.", "Kaburgalar sakin.", "Dizler yumuşak, kilitli değil."},
		Wrong:     []string{"Yana yatma.", "Dambıllı omuzu kaldırma.", "Yürüme veya zıplama.", "Nefesi tutma."},
		Breathing: "Sakin nefes.",
		Safety:    "Yerinde dur. Dambılla yürüme, koşma, zıplama.",
		Voice:     Voice{Start: "Bir elde yarım kilo. Dik dur.", Mid: []string{"Yana yatma.", "Omuzlar eşit."}, Finish: "El değiştir."},
	},
}
