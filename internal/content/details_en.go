...
var detailsEN = map[string]Detail{
	...
	// ---- Ilya light dumbbells (0.5 kg only) ----
	"D01": {
		Desc:      "A slow rotator-cuff drill that steadies the shoulder for serves and groundstrokes. One 0.5 kg dumbbell, one arm at a time.",
		HowTo:     []string{"Stand tall holding one 0.5 kg dumbbell.", "Bend the elbow to 90° and pin it to your side.", "Start with the forearm across your belly.", "Slowly rotate the forearm outward, away from the body.", "Return slowly, then switch arms."},
		Correct:   []string{"Keep the elbow glued to your side.", "Move slowly, no swing.", "Keep the shoulder down, away from the ear.", "Keep the wrist straight."},
		Wrong:     []string{"Don't let the elbow drift forward or out.", "Don't jerk the weight.", "Don't shrug.", "Don't use a heavier dumbbell."},
		Breathing: "Breathe evenly; do not hold your breath.",
		Safety:    "0.5 kg only. Stop if the shoulder hurts. Never run or jump with the dumbbell.",
		Voice:     Voice{Start: "Half-kilo dumbbell. Elbow glued to your side.", Mid: []string{"Rotate the forearm out slowly.", "Elbow stays put."}, Finish: "Put the dumbbell down."},
	},
	"D02": {
		Desc:      "A bent-over reverse fly for the rear shoulders and shoulder blades — the posture muscles a tennis player needs.",
		HowTo:     []string{"Hold a 0.5 kg dumbbell in each hand.", "Hinge at the hips with a straight back and soft knees.", "Let the arms hang under the shoulders.", "Raise the arms out to the sides up to shoulder height and squeeze the shoulder blades.", "Lower slowly."},
		Correct:   []string{"Keep the back long and flat.", "Stop at shoulder height.", "Squeeze the shoulder blades.", "Move both arms together."},
		Wrong:     []string{"Don't round the back.", "Don't swing the weights.", "Don't lift above the shoulders.", "Don't look up and crunch the neck."},
		Breathing: "Exhale as the arms rise.",
		Safety:    "0.5 kg only. Soft knees. Never jump with the dumbbells.",
		Voice:     Voice{Start: "Hinge, back straight, half-kilo in each hand.", Mid: []string{"Arms out to the sides.", "Squeeze the shoulder blades."}, Finish: "Stand up and put them down."},
	},
	"D03": {
		Desc:      "A goblet squat: both 0.5 kg dumbbells held at the chest to train legs and a stable racket-ready posture.",
		HowTo:     []string{"Hold both 0.5 kg dumbbells together at the chest.", "Stand with feet about shoulder-width apart.", "Sit the hips back and bend the knees.", "Keep the heels down and the chest tall.", "Stand up without letting the weights drift forward."},
		Correct:   []string{"Keep the dumbbells at the chest.", "Keep the heels on the floor.", "Keep the knees over the toes.", "Keep the back long."},
		Wrong:     []string{"Don't let the knees cave in.", "Don't lift the heels.", "Don't let the dumbbells pull you forward.", "Don't bounce out of the bottom."},
		Breathing: "Inhale down, exhale up.",
		Safety:    "Don't jump with the dumbbells. If a knee hurts, switch to a bodyweight squat.",
		Voice:     Voice{Start: "Dumbbells at the chest. Slow squat.", Mid: []string{"Heels down.", "Knees over the toes."}, Finish: "Stand tall."},
	},
	"D04": {
		Desc:      "A still overhead hold with 0.5 kg dumbbells that trains the shoulder stability used on the serve.",
		HowTo:     []string{"Hold a 0.5 kg dumbbell in each hand.", "Press both arms straight overhead.", "Bring the biceps close to the ears.", "Keep the ribs down and the belly tight.", "Hold still and breathe until the time ends, then lower slowly."},
		Correct:   []string{"Keep the arms by the ears.", "Keep the ribs down, no back arch.", "Keep the shoulders away from the ears.", "Keep breathing."},
		Wrong:     []string{"Don't lean back.", "Don't shrug.", "Don't lock and grind the elbows.", "Don't jerk the weights up."},
		Breathing: "Slow breaths. Never hold the breath.",
		Safety:    "Hold only — no presses or swings. If the shoulder shakes or hurts, lower the dumbbells.",
		Voice:     Voice{Start: "Half-kilo overhead. Arms by the ears.", Mid: []string{"Ribs down.", "Keep breathing."}, Finish: "Lower slowly."},
	},
	"D05": {
		Desc:      "A suitcase hold: one 0.5 kg dumbbell in one hand. The job is to stay tall and not tip — the same anti-side-bend strength used when lunging for a ball.",
		HowTo:     []string{"Hold one 0.5 kg dumbbell in one hand, arm hanging by the thigh.", "Stand with feet under the hips.", "Stay tall: don't lean toward the weight or away from it.", "Hold still and breathe.", "Switch hands for the other side."},
		Correct:   []string{"Stand as if a string pulls the crown up.", "Keep both shoulders level.", "Keep the ribs quiet.", "Keep the knees soft, not locked."},
		Wrong:     []string{"Don't lean sideways.", "Don't hike the shoulder of the weighted arm.", "Don't walk or bounce.", "Don't hold your breath."},
		Breathing: "Calm breaths in and out through the nose if you can.",
		Safety:    "Stand in place. Don't walk, run or jump with the dumbbell.",
		Voice:     Voice{Start: "One half-kilo in one hand. Stand tall.", Mid: []string{"Don't lean.", "Shoulders level."}, Finish: "Switch hands."},
	},
}
