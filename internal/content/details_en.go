...
var detailsEN = map[string]Detail{
	...
	"W09": {
		...
		Correct: []string{"Arms move freely.", "Shoulders stay relaxed.", "Chest opens gently.", "Body stays upright."},
		Wrong:   []string{"Swinging too aggressively.", "Raising the shoulders to the ears.", "Arching the lower back.", "Turning the movement into uncontrolled momentum."},
	},
	"C13": {
		...
		Correct: []string{"Rotation comes from the torso.", "Lower back stays controlled.", "Neck stays relaxed.", "Movement is smooth."},
		Wrong:   []string{"Pulling on the neck.", "Moving only the elbows.", "Rushing the reps.", "Letting the lower back arch."},
	},
	"B11": {
	...
	"L10": {
		...
		Correct: []string{"Knees follow the toes.", "Heels stay on the floor.", "Back stays long.", "Depth stays controlled."},
		Wrong:   []string{"Letting the knees collapse inward.", "Lifting the heels.", "Rounding the back.", "Dropping too fast."},
	},
	"L11": {
		...
		Correct: []string{"Front knee follows the toes.", "Torso stays upright.", "Step back is controlled.", "Front heel stays grounded."},
		Wrong:   []string{"Letting the front knee collapse inward.", "Leaning too far forward.", "Dropping quickly.", "Pushing off the back leg too hard."},
	},
	"L12": {
	...
	"J01": {
		...
		Correct: []string{"Jumps are low.", "Landings are soft and quiet.", "Knees stay slightly bent.", "Body stays tall."},
		Wrong:   []string{"Jumping too high.", "Landing loudly.", "Locking the knees.", "Letting the ankles roll inward or outward."},
	},
	"J02": {
		...
		Correct: []string{"Torso stays upright.", "Knees lift under control.", "Feet land softly.", "Breathing stays steady."},
		Wrong:   []string{"Leaning backward.", "Swinging the legs without control.", "Slamming the feet down.", "Holding the breath."},
	},
	"J03": {
		...
		Correct: []string{"Land softly.", "Keep the knees slightly bent.", "Arms move smoothly.", "Breathing stays rhythmic."},
		Wrong:   []string{"Landing hard.", "Locking the knees.", "Shrugging the shoulders.", "Moving too fast and losing control."},
	},
	"J04": {
		...
		Correct: []string{"Body stays in a strong plank.", "Core stays tight.", "Shoulders stay over the hands.", "Knees move under control."},
		Wrong:   []string{"Letting the hips bounce high.", "Dropping the lower back.", "Moving the feet too wildly.", "Letting the shoulders collapse."},
	},
	"J05": {
		...
		Correct: []string{"Land quietly.", "Knees follow the toes.", "Chest stays open.", "Each jump is controlled."},
		Wrong:   []string{"Landing hard.", "Letting the knees collapse inward.", "Jumping before the squat is stable.", "Rushing without resetting."},
	},
	"J06": {
		...
		Correct: []string{"Landings are quiet.", "Knee follows the toes.", "Torso stays controlled.", "Side-to-side movement is smooth."},
		Wrong:   []string{"Landing with the knee collapsing inward.", "Jumping too far too soon.", "Falling into the landing.", "Twisting the knee on contact."},
	},
	"J07": {
		...
		Correct: []string{"Knees lift toward hip height.", "Landings stay light.", "Core stays engaged.", "Torso stays tall."},
		Wrong:   []string{"Leaning backward.", "Landing heavily.", "Letting the feet slap the floor.", "Losing posture as the pace increases."},
	},
	"J08": {
		...
		Correct: []string{"Hands land under the shoulders.", "Plank position is strong.", "Feet land softly.", "Jump is controlled."},
		Wrong:   []string{"Dropping the lower back in the plank.", "Landing heavily.", "Rushing through sloppy reps.", "Letting the knees collapse inward when jumping forward."},
	},
	"J09": {
		...
		Correct: []string{"Landing is soft and controlled.", "Front knee follows the toes.", "Torso stays upright.", "Range of motion stays safe."},
		Wrong:   []string{"Landing hard.", "Letting the front knee cave inward.", "Dropping too deep.", "Moving faster than you can control."},
	},
	"CD07": {
