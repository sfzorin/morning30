...
var detailsFR = map[string]Detail{
	...
	// ---- Ilya : haltères légers 0,5 kg ----
	"D01": {
		Desc:      "Rotation externe lente de l'épaule pour stabiliser le service et les coups. Un haltère de 0,5 kg, un bras à la fois.",
		HowTo:     []string{"Tiens-toi droit avec un haltère de 0,5 kg.", "Plie le coude à 90° et colle-le au flanc.", "L'avant-bras commence devant le ventre.", "Écarte l'avant-bras vers l'extérieur, lentement.", "Reviens lentement, puis change de bras."},
		Correct:   []string{"Le coude reste collé au flanc.", "Mouvement lent, sans élan.", "Épaule basse, loin de l'oreille.", "Poignet droit."},
		Wrong:     []string{"Ne laisse pas le coude partir en avant.", "Ne donne pas d'à-coups.", "Ne hausse pas l'épaule.", "Ne prends pas plus lourd."},
		Breathing: "Respire régulièrement, ne bloque pas.",
		Safety:    "0,5 kg seulement. Arrête si l'épaule fait mal. Ne cours pas et ne saute pas avec l'haltère.",
		Voice:     Voice{Start: "Haltère d'un demi-kilo. Coude collé au flanc.", Mid: []string{"Avant-bras vers l'extérieur, lentement.", "Le coude ne bouge pas."}, Finish: "Pose l'haltère."},
	},
	"D02": {
		Desc:      "Oiseau penché pour l'arrière d'épaule et les omoplates — la posture du joueur de tennis.",
		HowTo:     []string{"Un haltère de 0,5 kg dans chaque main.", "Penche-toi depuis les hanches, dos droit, genoux souples.", "Les bras pendent sous les épaules.", "Élève les bras sur les côtés jusqu'à hauteur d'épaules et serre les omoplates.", "Redescends lentement."},
		Correct:   []string{"Dos long et plat.", "S'arrêter à hauteur d'épaules.", "Serrer les omoplates.", "Les deux bras ensemble."},
		Wrong:     []string{"Ne rondis pas le dos.", "Ne balance pas les poids.", "Ne monte pas au-dessus des épaules.", "Ne relève pas la tête."},
		Breathing: "Expire quand les bras montent.",
		Safety:    "0,5 kg seulement. Genoux souples. Ne saute pas avec les haltères.",
		Voice:     Voice{Start: "Penché, dos droit, un demi-kilo dans chaque main.", Mid: []string{"Bras sur les côtés.", "Serre les omoplates."}, Finish: "Redresse-toi et pose-les."},
	},
	"D03": {
		Desc:      "Squat goblet : les deux haltères de 0,5 kg contre la poitrine pour les jambes et une posture de frappe stable.",
		HowTo:     []string{"Tiens les deux haltères de 0,5 kg ensemble contre la poitrine.", "Pieds à peu près à largeur d'épaules.", "Recule les hanches et plie les genoux.", "Talons au sol, poitrine ouverte.", "Remonte sans laisser les poids partir en avant."},
		Correct:   []string{"Haltères contre la poitrine.", "Talons au sol.", "Genoux dans l'axe des orteils.", "Dos long."},
		Wrong:     []string{"Ne laisse pas les genoux rentrer.", "Ne lève pas les talons.", "Ne te laisse pas tirer en avant.", "Ne rebondis pas en bas."},
		Breathing: "Inspire en descendant, expire en montant.",
		Safety:    "Ne saute pas avec les haltères. Si le genou fait mal, squat sans poids.",
		Voice:     Voice{Start: "Haltères à la poitrine. Squat lent.", Mid: []string{"Talons au sol.", "Genoux dans l'axe."}, Finish: "Tiens-toi droit."},
	},
	"D04": {
		Desc:      "Maintien immobile d'haltères de 0,5 kg au-dessus de la tête — stabilité d'épaule comme au service.",
		HowTo:     []string{"Un haltère de 0,5 kg dans chaque main.", "Pousse les deux bras tendus au-dessus de la tête.", "Biceps près des oreilles.", "Côtes vers le bas, ventre serré.", "Reste immobile et respire, puis redescends lentement."},
		Correct:   []string{"Bras près des oreilles.", "Côtes basses, pas de cambrure.", "Épaules loin des oreilles.", "Continue de respirer."},
		Wrong:     []string{"Ne te cambre pas.", "Ne hausse pas les épaules.", "Ne bloque pas les coudes en force.", "Ne jette pas les poids vers le haut."},
		Breathing: "Respiration calme. Ne bloque jamais.",
		Safety:    "Tenir seulement, pas de développés ni d'élans. Si l'épaule tremble ou fait mal, descends.",
		Voice:     Voice{Start: "Demi-kilo au-dessus de la tête. Bras près des oreilles.", Mid: []string{"Côtes vers le bas.", "Continue de respirer."}, Finish: "Redescends lentement."},
	},
	"D05": {
		Desc:      "Hold valise : un haltère de 0,5 kg dans une main. Le but est de rester droit sans basculer.",
		HowTo:     []string{"Un haltère de 0,5 kg dans une main, bras le long de la cuisse.", "Pieds sous les hanches.", "Reste grand : ne penche ni vers le poids ni de l'autre côté.", "Reste immobile et respire.", "Change de main."},
		Correct:   []string{"Sommet du crâne vers le haut.", "Épaules au même niveau.", "Côtes calmes.", "Genoux souples, pas verrouillés."},
		Wrong:     []string{"Ne penche pas sur le côté.", "Ne hausse pas l'épaule du côté chargé.", "Ne marche pas et ne rebondis pas.", "Ne bloque pas ta respiration."},
		Breathing: "Respiration calme.",
		Safety:    "Reste sur place. Ne marche pas, ne cours pas, ne saute pas avec l'haltère.",
		Voice:     Voice{Start: "Un haltère d'un demi-kilo dans une main. Tiens-toi droit.", Mid: []string{"Ne penche pas.", "Épaules au même niveau."}, Finish: "Change de main."},
	},
}
