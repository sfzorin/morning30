...
export const POSES = {
  ...
  // ---- Back / scapula (prone) ----
  // cobra: prone, hips/legs on floor, chest propped on FOREARMS flat on the floor (elbow under
  // shoulder, forearm + palm flat forward). Like sphinx, a touch more lift.
  B01: {view:'side', pose:{...PRONE, spine:[0.93,0.27,0],front:[0.27,-0.93,0],head:[0.9,0.3,0], Luarm:[0,-1,0],Lfarm:[1,0,0],Lhand:[1,0,0], Ruarm:[0,-1,0],Rfarm:[1,0,0],Rhand:[1,0,0]}}, // cobra hold
  ...
  // sphinx: prone, hips/legs flat on the floor, chest gently propped on FOREARMS flat on the
  // floor (elbow under shoulder, forearm + palm flat forward).
  CD04: {view:'side', pose:{...PRONE, spine:[0.93,0.27,0],front:[0.27,-0.93,0],head:[0.9,0.3,0], Luarm:[0,-1,0],Lfarm:[1,0,0],Lhand:[1,0,0], Ruarm:[0,-1,0],Rfarm:[1,0,0],Rhand:[1,0,0]}}, // sphinx pose
  CD05: {view:'side', pose:{...PRONE, Lfarm:[1,-0.05,0],Lhand:[1,0,0],Rfarm:[1,-0.05,0],Rhand:[1,0,0]}},  // lying breathing (prone, arms forward flat on floor)
