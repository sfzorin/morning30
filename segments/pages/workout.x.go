...
// playerData is everything the client player needs. Doors JSON-encodes this
// into $data("payload") as an object (not a double-encoded string).
func (w workoutPage) playerData() playerPayload {
	...
	if w.sess.Jokes {
		...
		jokes = i18n.RestJokesSample(l, n)
	}
	p := playerPayload{
		Day:       day,
		Lang:      w.sess.Lang,
...
//line workout.gox:323
					__e = __c.Set("class", "rest-joke hidden"); if __e != nil { return }
					__e = __c.Submit(); if __e != nil { return }
				}
				__e = __c.Close(); if __e != nil { return }
				__e = __c.Init("div"); if __e != nil { return }
...
//line workout.gox:373
				__e = __c.Set("data:payload", payload); if __e != nil { return }
